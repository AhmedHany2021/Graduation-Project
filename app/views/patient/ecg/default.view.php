                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td onClick="document.location.href='/ecg/graph/<?php echo $value->id ?>'" onMouseOver="this.style.color='#00F'"
                                                        ...
                                                        <td  onClick="document.location.href='/ecg/delete/<?php echo $value->id ?>'" onMouseOver="this.style.color='#00F'"
